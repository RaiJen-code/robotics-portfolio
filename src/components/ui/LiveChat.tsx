...
const BOT_RESPONSES: Record<string, string> = {
  ...
  greeting: 'Hei! Saya aRJey — Robotics & AI Engineer. Ada yang bisa saya bantu? Konsultasi, 3D printing, atau kolaborasi project?',
        ...
        >
          ...
          <div className="h-14 flex items-center justify-between px-4 bg-dark-700 border-b border-dark-600">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-heading text-sm font-semibold text-dark-50">aRJey</p>
